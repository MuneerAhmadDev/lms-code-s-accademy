            ...
            <div class="position-relative home-sections testimonials-container">
                ...
                <div id="parallax1" class="ltr">
                    <!--<div data-depth="0.2" class="gradient-box left-gradient-box"></div>-->
                     <div data-depth="0.2" class="gradient-box left-gradient-box" style="background: none !important;">
                        <img src="<?php echo e(asset('assets/default/img/home/3.png')); ?>" alt="Gradient Background"
                            style="width: 100%;">
                    </div>
                </div>
                ...
                <div id="parallax2" class="ltr">
                    ...
                    <div data-depth="0.4" class="gradient-box right-gradient-box" style="background: none !important">
                        <img src="<?php echo e(asset('assets/default/img/home/2.png')); ?>" alt="Gradient Background"
                            style="width: 100%; transform: rotate(217deg);">
                    </div>
                </div>

                <div id="parallax3" class="ltr">
                    <!--<div data-depth="0.8" class="gradient-box bottom-gradient-box"></div>-->
                    <div data-depth="0.8" class="gradient-box bottom-gradient-box" style="background: none !important;">
                        <img src="<?php echo e(asset('assets/default/img/home/1.png')); ?>" alt="Gradient Background"
                            style="width: 100%;">
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                        <div class="position-relative ">
                            ...
                            <img src="/assets/default/img/home/circle-4.png" class="find-instructor-section-circle" alt="circle">
                            <img src="/assets/default/img/home/dot.png" class="find-instructor-section-dots" alt="dots" style="bottom: -16px; left: -23%; animation: hero-dot 5s linear 0s infinite alternate; width: 40%;">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="">
                            ...
                            <p class="font-16 font-weight-normal text-gray mt-10"><?php echo $forumSection['description'] ?? ''; ?></p>

                            <div class="mt-35 d-flex align-items-center">
                                <a href="<?php echo e($forumSection['button1']['link']); ?>" target="_blank" class="btn btn-primary discord-btn rounded">
                                    ...
                                    <?php echo e($forumSection['button1']['title']); ?>

                                </a>
                                <!-- <?php if(!empty($forumSection['button1']) and !empty($forumSection['button1']['title']) and !empty($forumSection['button1']['link'])): ?>
                                    <a href="<?php echo e($forumSection['button1']['link']); ?>" class="btn btn-primary mr-15 discord-btn">
                                ...
                                <?php if(!empty($forumSection['button2']) and !empty($forumSection['button2']['title']) and !empty($forumSection['button2']['link'])): ?>
                                    <a href="<?php echo e($forumSection['button2']['link']); ?>" class="btn btn-outline-primary discord-btn">
                                        ...
                                        <?php echo e($forumSection['button2']['title']); ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>