                    ...
                    <ul class="sidenav-item-collapse">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('panel_webinars_my_purchases')): ?>
                            <li class="mt-5 <?php echo e((request()->is('panel/webinars/purchases')) ? 'active' : ''); ?>">
                                <a href="/panel/webinars/purchases"><?php echo e(trans('panel.my_courses')); ?></a>
                            </li>
                        <?php endif; ?>
...
<?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>