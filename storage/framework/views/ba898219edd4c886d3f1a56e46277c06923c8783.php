        ...
        <div class="row">
            <div class="col-12">
                <div class=" footer-subscribe d-block d-md-flex align-items-center justify-content-between" style="visibility: hidden; height: 60px;">
                    ...
                    <?php echo e(trans('footer.discord_channel')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/includes/footer.blade.php ENDPATH**/ ?>