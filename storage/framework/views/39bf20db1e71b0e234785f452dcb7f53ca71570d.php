            ...
            <div class="carousel-inner h-100">
                ...
                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item h-100 <?php echo e($key === 0 ? 'active' : ''); ?>">
                        <img src="<?php echo e($image); ?>" class="d-block w-100 h-100" alt="Carousel Image"
        ...
        <div class="container h-100" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; z-index: 10;">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        <h1 class="text-white font-30 mb-15"><?php echo e(!empty($category) ? $category->title : $pageTitle); ?></h1>
                        <span class="course-count-badge py-2 px-10 text-white rounded"><?php echo e($webinarsCount); ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/pages/categories.blade.php ENDPATH**/ ?>