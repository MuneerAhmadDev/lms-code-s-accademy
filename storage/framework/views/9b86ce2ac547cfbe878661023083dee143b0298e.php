<div class="webinar-card">
    <figure>
        ...
        <figcaption class="webinar-card-body">
            ...
            <a href="<?php echo e($webinar->getUrl()); ?>">
                <h3 class="mt-15 webinar-title font-weight-bold font-16 text-dark-blue"><?php echo clean($webinar->title,'title'); ?></h3>
            </a>
            ...
            <div class="d-flex justify-content-between mt-20">
                <div class="d-flex align-items-center">
                    ...
                    <!--<span class="duration font-14 ml-5"><?php echo e(convertMinutesToHourAndMinute($webinar->duration)); ?> <?php echo e(trans('home.hours')); ?></span>-->
                       <?php
                        $days = floor($webinar->duration / 1440); // Total days
                        $hours = floor(($webinar->duration % 1440) / 60); // Remaining hours
                        $minutes = $webinar->duration % 60; // Remaining minutes
                    ?>

                    <span class="duration font-14 ml-5">
                        <?php echo e($days); ?> days, <?php echo e($hours); ?> hours, <?php echo e($minutes); ?> mins
                    </span>
                </div>
...
<?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/includes/webinar/grid-card.blade.php ENDPATH**/ ?>