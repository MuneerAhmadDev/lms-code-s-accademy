...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mt-30">
        <section class="rounded-lg border px-10 pb-35 pt-5 position-relative">
            <ul class="nav nav-tabs d-flex align-items-center px-20 px-lg-50 pb-15" id="tabs-tab" role="tablist" style="display: none !important;">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade px-20 px-lg-50 <?php echo e((empty(request()->get('tab')) or request()->get('tab') == 'about') ? 'show active' : ''); ?>" id="appointments" role="tabpanel" aria-labelledby="about-tab">
                ...
                <div class="tab-pane fade px-20 px-lg-50 <?php echo e((request()->get('tab') == 'appointments') ? 'show active' : ''); ?>" id="about" role="tabpanel" aria-labelledby="appointments-tab">
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/user/profile.blade.php ENDPATH**/ ?>