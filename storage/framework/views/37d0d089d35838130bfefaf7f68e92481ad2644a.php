...
<head>
    ...
    <?php echo $__env->yieldPushContent('style'); ?>
        <style>
        <?php echo !empty(getCustomCssAndJs('css')) ? getCustomCssAndJs('css') : ''; ?> <?php echo getThemeFontsSettings(); ?> <?php echo getThemeColorsSettings(true); ?>


        /* Apply font style to all <h2> tags */
        h5 {
            font-family: 'main-font-family', sans-serif !important;
        }
    </style>
</head>
        ...
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                ...
                <h5 class="text-muted-transparent img-title">Learning Management Center</h5>
              </div>
...
<?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>