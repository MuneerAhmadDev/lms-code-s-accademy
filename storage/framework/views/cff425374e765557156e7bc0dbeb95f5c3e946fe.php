                ...
                <div class="notification-card rounded-sm panel-shadow bg-white py-15 py-lg-20 px-15 px-lg-40 mt-20">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg-5 mt-10 mt-lg-0">
                            <span class="font-weight-500 text-gray font-14"><?php echo $notification->message; ?></span>
                        </div>
                        <?php
                        ...
                        <div class="col-12 col-lg-4 mt-10 mt-lg-0 text-right">
                            ...
                            <input type="hidden" class="notification-message" value="<?php echo $escapedHtml; ?>">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/panel/notifications/index.blade.php ENDPATH**/ ?>