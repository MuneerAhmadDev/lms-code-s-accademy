        ...
        <section class="">
            <?php if(!empty($contactSettings['latitude']) and !empty($contactSettings['longitude'])): ?>
               <div class="d-flex justify-content-center">
                    <div class="contact-map" id="contactMap" data-latitude="<?php echo e($contactSettings['latitude']); ?>"
                        data-longitude="<?php echo e($contactSettings['longitude']); ?>"
                        data-zoom="<?php echo e($contactSettings['map_zoom'] ?? 12); ?>" style="width: 700px; height: 460px;"></div>
                </div>
            <?php endif; ?>
                ...
                <div class="col-12 col-md-4">
                    <div class="contact-items mt-30 rounded-lg py-20 py-md-40 px-15 px-md-30 text-center">
                        <div class="contact-icon-box box-info p-20 d-flex align-items-center justify-content-center mx-auto" style="background-image: none;">
                            ...
                            <img src="<?php echo e(asset('assets/default/img/contact/address.png')); ?>" alt="" style="width: 100%;">
                        </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="contact-items mt-30 rounded-lg py-20 py-md-40 px-15 px-md-30 text-center">
                        <div class="contact-icon-box box-green p-20 d-flex align-items-center justify-content-center mx-auto" style="background-image: none;">
                            ...
                            <img src="<?php echo e(asset('assets/default/img/contact/phone.png')); ?>" alt="" style="width: 100%;">
                        </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="contact-items mt-30 rounded-lg py-20 py-md-40 px-15 px-md-30 text-center">
                        <div class="contact-icon-box box-red p-20 d-flex align-items-center justify-content-center mx-auto" style="background-image: none;">
                            ...
                            <img src="<?php echo e(asset('assets/default/img/contact/email.png')); ?>" alt="" style="width: 100%;">
                        </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/pages/contact.blade.php ENDPATH**/ ?>