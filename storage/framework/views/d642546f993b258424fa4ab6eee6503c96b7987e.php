                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="ajax[<?php echo e(!empty($assignment) ? $assignment->id : 'new'); ?>][deadline]" class="js-ajax-deadline form-control" value="<?php echo e(!empty($assignment) ? $assignment->deadline : ''); ?>" placeholder="in days" min="1"/>
                            <div class="invalid-feedback"></div>
                        </div>
...
<?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/admin/webinars/create_includes/accordions/assignment.blade.php ENDPATH**/ ?>