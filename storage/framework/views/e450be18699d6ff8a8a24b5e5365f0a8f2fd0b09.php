                ...
                <?php if(!empty($upcomingCourse->duration)): ?>
                    <div class="d-flex align-items-center">
                        ...
                        <!--<span class="duration font-14 ml-5"><?php echo e(convertMinutesToHourAndMinute($upcomingCourse->duration)); ?> <?php echo e(trans('home.hours')); ?></span>-->
                         <?php
                            $days = floor($upcomingCourse->duration / 1440); // Total days
                            $hours = floor(($upcomingCourse->duration % 1440) / 60); // Remaining hours
                            $minutes = $upcomingCourse->duration % 60; // Remaining minutes
                        ?>
...
<?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/includes/webinar/upcoming_course_grid_card.blade.php ENDPATH**/ ?>