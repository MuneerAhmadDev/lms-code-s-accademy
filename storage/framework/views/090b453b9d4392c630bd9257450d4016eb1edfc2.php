        ...
        <div class="row">
            ...
            <div class="course-content-sidebar col-12 col-lg-4 mt-25 mt-lg-0">
                <div class="rounded-lg shadow-sm">
                    ...
                    <div class="px-20 pb-30">
                        ...
                        <div class="mt-35">
                            ...
                            <strong class="d-block text-secondary font-weight-bold"><?php echo e(trans('webinars.this_webinar_includes_custom',['classes' => trans('webinars.'.$course->type)])); ?></strong>
                ...
                <div class="rounded-lg shadow-sm mt-35 px-25 py-20">
                    ...
                    <h3 class="font-16 text-secondary font-weight-bold"><?php echo e('Course '. trans('webinars.specifications')); ?></h3>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/course/index.blade.php ENDPATH**/ ?>