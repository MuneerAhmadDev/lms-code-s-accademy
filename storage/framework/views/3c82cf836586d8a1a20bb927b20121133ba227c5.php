...
<?php $__env->startSection('content'); ?>
    <section class="">
        ...
        <div class="bg-white dashboard-banner-container position-relative px-15 px-ld-35 py-10 panel-shadow rounded-sm">
            ...
            <div class="dashboard-banner p-2" style="height: 100%;">
                
                <video class="img-cover" autoplay loop muted='muted' playsinline>
                    <source src="<?php echo e(asset('assets/default/img/student_dashboard_video.mp4')); ?>" type="video/mp4">
        ...
        <div class="row">
            <div class="col-12 col-lg-3 mt-35">
                <div class="bg-white account-balance rounded-sm panel-shadow py-15 py-md-30 px-10 px-md-20">
                    ...
                    <div class="stat-icon requests" style="background-image: none;">
                        <img src="/assets/default/img/icons/purchased-course.png" alt="">
                    </div>
            ...
            <div class="col-12 col-lg-3 mt-35">
                <a href="/panel/support" class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 d-flex align-items-center">
                    <div class="stat-icon support-messages" style="background-image: none;">
                        <img src="/assets/default/img/icons/support-message.png" alt="">
                    </div>
                    <div class="d-flex flex-column ml-15">
                ...
                <a href="<?php if($authUser->isUser()): ?> /panel/webinars/my-comments <?php else: ?> /panel/webinars/comments <?php endif; ?>" class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 d-flex align-items-center mt-15 mt-md-30">
                    <div class="stat-icon comments" style="background-image: none;">
                        <img src="/assets/default/img/icons/comment.png" alt="">
                    </div>
                    <div class="d-flex flex-column ml-15">
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u547430766/domains/lms-code-s-academy.com/public_html/resources/views/web/default/panel/dashboard/index.blade.php ENDPATH**/ ?>