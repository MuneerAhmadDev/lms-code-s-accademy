...
class UpcomingCoursesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $storeData['german_description'] = $request->german_description ?? null;
        $storeData['title'] = $request->title ?? null;
        // return $storeData;
...
$translations = [
    ...
    'title' => $data['title'] ?? $upcomingCourse->title, // Use the updated title or fallback
    'german_description' => $request->german_description, // Add german description
];

// Update or create translation
$upcomingCourse->translations()->update(
    $translations
);
