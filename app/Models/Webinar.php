...
class Webinar extends Model implements TranslatableContract
{
    ...
    public $translatedAttributes = ['title', 'description', 'seo_description', 'german_description'];
    ...
    public function getGermanDescriptionAttribute()
    {
        return getTranslateAttributeValue($this, 'german_description');
    }
