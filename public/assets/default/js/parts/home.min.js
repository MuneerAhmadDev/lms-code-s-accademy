(function ($) {
  ...
  document.querySelectorAll('.discord-btn').forEach(button => {
      button.addEventListener('mouseover', function() {
          const img = this.querySelector('.discord-icon');
          img.src = img.src.includes('discord.svg') ? 'assets/default/img/social/discord-1.svg' : 'assets/default/img/social/discord.svg';
      });
      
      button.addEventListener('mouseout', function() {
          const img = this.querySelector('.discord-icon');
          img.src = img.src.includes('discord-1.svg') ? 'assets/default/img/social/discord.svg' : 'assets/default/img/social/discord-1.svg';
      });
  });
