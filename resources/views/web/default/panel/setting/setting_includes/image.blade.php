        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="form-group">
                ...
                <div class="input-group-prepend">
                        <button type="button" class="input-group-text panel-file-manager" data-input="profile_image" data-preview="holder">
                            <i data-feather="arrow-up" width="18" height="18" class="text-white"></i>
                        </button>
                    </div>
                    <input type="text" name="profile_image" id="profile_image" value="{{ !empty($user) ? $user->profile_image : old('profile_image') }}" class="form-control " placeholder="{{ trans('forms.course_cover_size') }}"/>
                </div>
            </div>
        </div>
