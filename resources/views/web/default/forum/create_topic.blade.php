...
@section('content')
    <div class="container">
        <section class="topics-title-section mt-30 mt-md-50 px-20 px-md-30 py-25 py-md-35 rounded-lg" style="background-position: center">
            <h1 class="font-30 font-weight-bold">{{ !empty($topic) ? trans('update.edit_topic') : trans('update.new_topic') }}</h1>
            <p class="font-14">{{ trans('update.new_topic_hint') }}</p>

            <div class="mt-10">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb p-0 m-0">
                        <li class="breadcrumb-item font-12"><a href="/" class="">{{ getGeneralSettings('site_name') }}</a></li>
                        <li class="breadcrumb-item font-12"><a href="/forums" class="">{{ trans('update.forum') }}</a></li>
                        <li class="breadcrumb-item font-12 font-weight-bold" aria-current="page">{{ !empty($topic) ? trans('update.edit_topic') : trans('update.new_topic') }}</li>
                    </ol>
                </nav>
            </div>
        </section>
