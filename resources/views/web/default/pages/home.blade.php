            ...
            <div class="position-relative home-sections testimonials-container">
                ...
                <div id="parallax1" class="ltr">
                    <!--<div data-depth="0.2" class="gradient-box left-gradient-box"></div>-->
                     <div data-depth="0.2" class="gradient-box left-gradient-box" style="background: none !important;">
                        <img src="{{ asset('assets/default/img/home/3.png') }}" alt="Gradient Background"
                            style="width: 100%;">
                    </div>
                </div>
                ...
                <div id="parallax2" class="ltr">
                    ...
                    <div data-depth="0.4" class="gradient-box right-gradient-box" style="background: none !important">
                        <img src="{{ asset('assets/default/img/home/2.png') }}" alt="Gradient Background"
                ...
                <div id="parallax3" class="ltr">
                    ...
                    <div data-depth="0.8" class="gradient-box bottom-gradient-box" style="background: none !important;">
                        <img src="{{ asset('assets/default/img/home/1.png') }}" alt="Gradient Background"
                            style="width: 100%;">
                    </div>
                </div>
            </div>
