        ...
        <div class="stats-container {{ $heroSection == '2' ? 'page-has-hero-section-2' : '' }}">
            <div class="container">
                <div class="row">
                    ...
                    {{-- Old Code Hide two and show only One: that show courses --}}
                    {{-- <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                    <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                ...
                <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                    <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                        <div class="stat-icon-box course" style="background-image:none;">
                    ...
                    <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            ...
                            <strong
                                class="stat-number mt-10">{{ $homeDefaultStatistics['liveClassCount'] + $homeDefaultStatistics['coursesCount'] }}</strong>
                            <h4 class="stat-title">{{ trans('home.courses') }}</h4>
                            <p class="stat-desc mt-10">{{ trans('home.live_classes_hint') }}</p>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                            <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                                <div class="stat-icon-box "
                                    style="background-color: {{ $homeCustomStatistic->color }}">
