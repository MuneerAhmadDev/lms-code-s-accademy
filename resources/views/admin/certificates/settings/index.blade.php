                                ...
                                <div class="col-12 col-md-6">
                                    <form action="{{ getAdminPanelUrl('/certificates/settings') }}" method="post">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <a href="https://htmlcsstoimage.com"  >Get Certificate Builder API here</a><br>
                                            <a href="https://htmlcsstoimage.com/dashboard/api-keys"  >Copy Builder API here</a>
                                            
                                            <img src="https://cdn-ghkoj.nitrocdn.com/kjYfdEBKRwdYwvHQyjaYBdTGFpFGjqYW/assets/images/optimized/rev-39d8e95/sertifier.com/blog/wp-content/uploads/2020/10/certificate-text-samples.jpg" alt="Get Certificate" style="width: -webkit-fill-available;">
