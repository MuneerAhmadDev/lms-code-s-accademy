                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="ajax[{{ !empty($assignment) ? $assignment->id : 'new' }}][deadline]" class="js-ajax-deadline form-control" value="{{ !empty($assignment) ? $assignment->deadline : '' }}" placeholder="in days" min="1"/>
                            <div class="invalid-feedback"></div>
                        </div>
