                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mt-15">
                                                ...
                                                <textarea id="summernote_german" name="german_description" class="form-control @error('description')  is-invalid @enderror"
                                                    placeholder="{{ trans('forms.webinar_description_placeholder') }}">{!! !empty($webinar) ? $webinar->german_description : old('german_description') !!}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
