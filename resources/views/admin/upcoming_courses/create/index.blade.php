        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">
                    {{ !empty($upcomingCourse) ? trans('/admin/main.edit') : trans('admin/main.new') }}</div>
            </div>
        </div>
                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post"
                                action="{{ getAdminPanelUrl('/upcoming_courses/' . (!empty($upcomingCourse) ? $upcomingCourse->id . '/update' : 'store')) }}"
                                id="upcomingCourseForm" class="webinar-form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish"
                                            class="btn btn-success">{{ !empty($upcomingCourse) ? trans('admin/main.save_and_publish') : trans('admin/main.save_and_continue') }}</button>
                                        ...
                                        @if (!empty($upcomingCourse))
                                            ...
                                            @include('admin.includes.delete_button', [
                                                'url' => getAdminPanelUrl(
                                                    '/upcoming_courses/' . $upcomingCourse->id . '/delete'),
